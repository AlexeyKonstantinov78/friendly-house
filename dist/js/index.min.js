...
"use strict";var sliderAll=function(){new Swiper(".swiper1"),new Swiper(".swiper2")},pets=function(){new Swiper(".swiper3",{autoHeight:!0,slidesPerView:1,centeredSlides:!0,centerInsufficientSlides:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})};window.addEventListener("DOMContentLoaded",(function(){window.screen.width<=640&&sliderAll(),window.screen.height<=840&&pets()})),window.addEventListener("resize",(function(){window.screen.width<=640&&sliderAll(),window.screen.height<=840&&pets()}));
