...
"use strict";var sliderAll=function(){new Swiper(".swiper1"),new Swiper(".swiper2")};window.addEventListener("DOMContentLoaded",(function(){window.screen.width<=640&&sliderAll()})),window.addEventListener("resize",(function(){window.screen.width<=640&&sliderAll()}));
